		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "pruebas",
									"targetURL": "#pruebaspruebas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pruebaspruebas-display": {
								"semanticObject": "pruebaspruebas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pruebas.pruebas",
									"url": sap.ui.require.toUrl("pruebas/pruebas")
								}
							}
						}
					}
